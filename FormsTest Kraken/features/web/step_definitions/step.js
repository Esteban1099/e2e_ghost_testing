...
Then('I click on the redact message inputbox {kraken-string}', async function (contenido) {
    let element = await this.driver.$('.gh-editor-title');
    return await element.setValue(contenido);
  });

Then('I click on message inputbox', async function () {
    let element = await this.driver.$('.gh-editor-title');
    return await element.click();
  });
...
Then('I click on the redact name inputbox {kraken-string}', async function (contenido) {
    let element = await this.driver.$('#tag-name');
    return await element.setValue(contenido);
  });

Then('I click on the redact name member inputbox {kraken-string}', async function (contenido) {
    let element = await this.driver.$('#member-name');
    return await element.setValue(contenido);
  });


Then('I click on the redact email inputbox {kraken-string}', async function (contenido) {
    let element = await this.driver.$('#member-email');
    return await element.setValue(contenido);
  });

Then('I click on the redact description inputbox {kraken-string}', async function (contenido) {
...
Then('I click on post inputbox', async function () {
    let element = await this.driver.$('.koenig-editor');
    return await element.click();
  });

Then('I click on the redact post inputbox {kraken-string}', async function (contenido) {
    let element = await this.driver.$('.koenig-editor');
    await element.click();
    return await element.setValue(contenido);
  });
